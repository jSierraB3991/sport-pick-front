        ...
        <div className="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100">
            ...
            <div className="bg-gradient-to-r from-slate-900 via-slate-800 to-slate-900 px-4 py-4 shadow-xl sticky top-0 z-50">
                <div className="max-w-7xl mx-auto flex items-center justify-between">
                    ...
                    <div className="flex items-center gap-4">
                        <span className="text-white text-sm hidden sm:block">Usuario</span>
                        <button
                            ...
                            return (
                                <Link
                                    ...
                                    className={`flex items-center gap-3 px-4 py-3 rounded-lg transition-colors ${
                                        isActive(item.path) ? "bg-gradient-to-r from-teal-500 to-teal-600 text-white" : "text-slate-700 hover:bg-slate-100"
                                    }`}>
                                    <Icon size={20} />
